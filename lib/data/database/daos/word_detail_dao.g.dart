...
part of 'word_detail_dao.dart';

// ignore_for_file: type=lint
mixin _$WordDetailDaoMixin on DatabaseAccessor<AppDatabase> {
  ...
  WordDetailDaoManager get managers => WordDetailDaoManager(this);
}

class WordDetailDaoManager {
  final _$WordDetailDaoMixin _db;
  WordDetailDaoManager(this._db);
